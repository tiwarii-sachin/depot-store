  ...
  return (
    <div className="max-w-md mx-auto px-4 md:px-6 py-20">
      <div className="crate-card p-8">
        <span className="font-mono text-xs text-safetyDark tracking-widest">NEW MANIFEST</span>
        <h1 className="stencil text-3xl text-navy mt-2 mb-6">Create Account</h1>
        ...
        <p className="font-mono text-xs text-ink/50 mt-5 text-center">
          Already have an account? <Link to="/login" className="text-safetyDark hover:underline">Log in</Link>
        </p>
      </div>
    </div>
  );
